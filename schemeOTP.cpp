...
Generate and share multiple folders to have spare keys.  The following 253 files conjure automated  dual-channel symmetry:
--------------------------------------------------------------------------------------------------------------------------
 * keys                           (Folder)
...
the party involved can swap and restore channels at any time (option 4.)  This gives you an addidional 125 times to encrypt.
...
#include <fstream>    //For file I/O (creates, writes to, and reads from ONLY the 253 files mentioned above.)
#include <iostream>
